...
export declare class H5PStandalone {
    ...
    prepareH5PEnvironment(contentId: string, options: Options): Promise<H5PIntegration>;
    ...
    findAllDependencies(h5pJsonContent: H5PPackageDefinition, librariesPath: string, assetsRequestFetchOptions?: RequestInit): Promise<LocalLibraryDependency[]>;
