...
* [`h5p-view-all`](./h5p-view-all) - a bash script that allows you to play/view all the 55 H5P examples in this repository; simply use `Ctrl-C` at the command line to end the current example and restart the server for the next H5P example in this directory.  
